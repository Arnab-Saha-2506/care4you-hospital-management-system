    ...
    if($_POST){
        ...
        if ($password==$cpassword){
            ...
            if($id2!=$id){
                ...
                //$sql1="insert into doctor(docemail,docname,docpassword,docuhid,doctel,specialties) values('$email','$name','$password','$uhid','$tele',$spec);";
                $sql1="update doctor set docemail='$email',docname='$name',docpassword='$password',docuhid='$uhid',doctel='$tele',specialties=$spec where docid=$id ;";
                $database->query($sql1);
